...
var _backgroundMp3 = require("url:./sound/background.mp3");
var _backgroundMp3Default = parcelHelpers.interopDefault(_backgroundMp3);
var _loseMp3 = require("url:./sound/lose.mp3");
var _loseMp3Default = parcelHelpers.interopDefault(_loseMp3);
...
let paused = 0;
let volume = 1;
let jumpSoundDino = new Audio((0, _jumpWavDefault.default));
let backgroundSoundDino = new Audio((0, _backgroundMp3Default.default));
backgroundSoundDino.volume = 0.5;
let dieSoundDino = new Audio((0, _loseMp3Default.default));
...
},{"./config.js":"jtCLN","./model.js":"dEDha","./view/ground.js":"jhjbi","./view/dino.js":"1hG7r","./view/score.js":"bXKFW","./view/cactus.js":"fuLgt","url:./sound/jump.wav":"bDorZ","url:./sound/background.mp3":"gTMYc","url:./sound/lose.mp3":"ecrpI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jtCLN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./helpers/bundle-url":"lgJ39"}],"bDorZ":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bWBrl") + "jump.de336476.wav" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"gTMYc":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bWBrl") + "background.9110946e.mp3" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"ecrpI":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bWBrl") + "lose.74ca256c.mp3" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["6KagL","gCE4p"], "gCE4p", "parcelRequire5ed6")
